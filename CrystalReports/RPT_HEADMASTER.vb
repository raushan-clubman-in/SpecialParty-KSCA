...
Public Class RPT_HEADMASTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.RPT_HEADMASTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_HEADMASTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_HEADMASTER = New RPT_HEADMASTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
