...
Public Class POSDETAILSDATEWISE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.POSDETAILSDATEWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOSDETAILSDATEWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POSDETAILSDATEWISE = New POSDETAILSDATEWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
