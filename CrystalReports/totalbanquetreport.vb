...
Public Class totalbanquetreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.totalbanquetreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtotalbanquetreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As totalbanquetreport = New totalbanquetreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
