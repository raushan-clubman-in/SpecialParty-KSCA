...
Public Class CRPT_PAR_GSTBILL123
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_GSTBILL123.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_GSTBILL123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_GSTBILL123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_GSTBILL123 = New CRPT_PAR_GSTBILL123()
        rpt.Site = Me.Site
        Return rpt
    End Function
