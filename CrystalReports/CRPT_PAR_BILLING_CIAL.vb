...
Public Class CRPT_PAR_BILLING_CIAL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_BILLING_CIAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_BILLING_CIAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLING_CIAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLING_CIAL = New CRPT_PAR_BILLING_CIAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
