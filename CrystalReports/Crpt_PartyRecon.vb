...
Public Class Crpt_PartyRecon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crpt_PartyRecon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpt_PartyRecon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpt_PartyRecon = New Crpt_PartyRecon()
        rpt.Site = Me.Site
        Return rpt
    End Function
