...
Public Class SMAUDIT_SUMMARY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.SMAUDIT_SUMMARY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSMAUDIT_SUMMARY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SMAUDIT_SUMMARY = New SMAUDIT_SUMMARY()
        rpt.Site = Me.Site
        Return rpt
    End Function
