...
Public Class deptDateWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.deptDateWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddeptDateWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As deptDateWise = New deptDateWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
