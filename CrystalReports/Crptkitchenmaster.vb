...
Public Class Crptkitchenmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptkitchenmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptkitchenmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptkitchenmaster = New Crptkitchenmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
