...
Public Class Crpt_Abstract_KSCA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crpt_Abstract_KSCA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpt_Abstract_KSCA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpt_Abstract_KSCA = New Crpt_Abstract_KSCA()
        rpt.Site = Me.Site
        Return rpt
    End Function
