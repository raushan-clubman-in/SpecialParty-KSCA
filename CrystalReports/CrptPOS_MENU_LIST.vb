...
Public Class CrptPOS_MENU_LIST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CrptPOS_MENU_LIST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptPOS_MENU_LIST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptPOS_MENU_LIST = New CrptPOS_MENU_LIST()
        rpt.Site = Me.Site
        Return rpt
    End Function
