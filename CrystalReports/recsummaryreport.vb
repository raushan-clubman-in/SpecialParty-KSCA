...
Public Class recsummaryreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.recsummaryreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrecsummaryreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As recsummaryreport = New recsummaryreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
