...
Public Class crptitemmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.crptitemmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrptitemmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptitemmaster = New crptitemmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
