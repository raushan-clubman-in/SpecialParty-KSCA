...
Public Class Crpttablemaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crpttablemaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpttablemaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpttablemaster = New Crpttablemaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
