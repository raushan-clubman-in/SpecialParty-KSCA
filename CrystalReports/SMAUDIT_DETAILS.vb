...
Public Class SMAUDIT_DETAILS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.SMAUDIT_DETAILS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSMAUDIT_DETAILS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SMAUDIT_DETAILS = New SMAUDIT_DETAILS()
        rpt.Site = Me.Site
        Return rpt
    End Function
