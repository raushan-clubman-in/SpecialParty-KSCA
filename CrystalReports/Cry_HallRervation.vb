...
Public Class Cry_HallRervation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Cry_HallRervation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_HallRervation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_HallRervation = New Cry_HallRervation()
        rpt.Site = Me.Site
        Return rpt
    End Function
