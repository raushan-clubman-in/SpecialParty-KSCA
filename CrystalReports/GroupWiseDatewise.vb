...
Public Class GroupWiseDatewise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.GroupWiseDatewise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGroupWiseDatewise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GroupWiseDatewise = New GroupWiseDatewise()
        rpt.Site = Me.Site
        Return rpt
    End Function
