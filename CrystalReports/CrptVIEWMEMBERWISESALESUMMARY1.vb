...
Public Class CrptVIEWMEMBERWISESALESUMMARY1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrptVIEWMEMBERWISESALESUMMARY1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CrptVIEWMEMBERWISESALESUMMARY1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptVIEWMEMBERWISESALESUMMARY1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptVIEWMEMBERWISESALESUMMARY1 = New CrptVIEWMEMBERWISESALESUMMARY1()
        rpt.Site = Me.Site
        Return rpt
    End Function
