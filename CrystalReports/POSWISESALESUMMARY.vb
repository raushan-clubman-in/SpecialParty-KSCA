...
Public Class POSWISESALESUMMARY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.POSWISESALESUMMARY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOSWISESALESUMMARY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POSWISESALESUMMARY = New POSWISESALESUMMARY()
        rpt.Site = Me.Site
        Return rpt
    End Function
