...
Public Class SMARTOVERIDE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.SMARTOVERIDE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSMARTOVERIDE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SMARTOVERIDE = New SMARTOVERIDE()
        rpt.Site = Me.Site
        Return rpt
    End Function
