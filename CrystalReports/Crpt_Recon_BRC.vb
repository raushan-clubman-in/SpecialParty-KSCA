...
Public Class Crpt_Recon_BRC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crpt_Recon_BRC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpt_Recon_BRC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpt_Recon_BRC = New Crpt_Recon_BRC()
        rpt.Site = Me.Site
        Return rpt
    End Function
