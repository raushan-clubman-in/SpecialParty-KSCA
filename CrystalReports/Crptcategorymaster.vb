...
Public Class Crptcategorymaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptcategorymaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptcategorymaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptcategorymaster = New Crptcategorymaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
