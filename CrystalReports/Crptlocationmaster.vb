...
Public Class Crptlocationmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptlocationmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptlocationmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptlocationmaster = New Crptlocationmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
