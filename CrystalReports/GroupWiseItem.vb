...
Public Class GroupWiseItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.GroupWiseItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGroupWiseItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GroupWiseItem = New GroupWiseItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
