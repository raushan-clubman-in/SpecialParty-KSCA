...
Public Class Crptservermaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptservermaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptservermaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptservermaster = New Crptservermaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
