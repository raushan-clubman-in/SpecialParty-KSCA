...
Public Class PARTY_ITEMDETAILS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.PARTY_ITEMDETAILS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTY_ITEMDETAILS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTY_ITEMDETAILS = New PARTY_ITEMDETAILS()
        rpt.Site = Me.Site
        Return rpt
    End Function
