...
Public Class crptsubgroupmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.crptsubgroupmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrptsubgroupmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptsubgroupmaster = New crptsubgroupmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
