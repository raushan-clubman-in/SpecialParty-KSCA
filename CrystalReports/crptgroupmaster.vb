...
Public Class crptgroupmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.crptgroupmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrptgroupmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptgroupmaster = New crptgroupmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
