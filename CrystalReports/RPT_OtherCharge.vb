...
Public Class RPT_OtherCharge
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.RPT_OtherCharge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_OtherCharge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_OtherCharge = New RPT_OtherCharge()
        rpt.Site = Me.Site
        Return rpt
    End Function
