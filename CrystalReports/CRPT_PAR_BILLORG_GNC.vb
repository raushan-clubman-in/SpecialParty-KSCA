...
Public Class CRPT_PAR_BILLORG_GNC
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_BILLORG_GNC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_BILLORG_GNC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLORG_GNC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLORG_GNC = New CRPT_PAR_BILLORG_GNC()
        rpt.Site = Me.Site
        Return rpt
    End Function
