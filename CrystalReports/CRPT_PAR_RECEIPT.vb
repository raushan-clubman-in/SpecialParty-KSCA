...
Public Class CRPT_PAR_RECEIPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_RECEIPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_RECEIPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_RECEIPT = New CRPT_PAR_RECEIPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
