...
Public Class CRPT_PAR_NGSTBILL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_NGSTBILL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_NGSTBILL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_NGSTBILL = New CRPT_PAR_NGSTBILL()
        rpt.Site = Me.Site
        Return rpt
    End Function
