...
Public Class RPT_HALLSTATUS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.RPT_HALLSTATUS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_HALLSTATUS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_HALLSTATUS = New RPT_HALLSTATUS()
        rpt.Site = Me.Site
        Return rpt
    End Function
