...
Public Class Crptwaitermaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptwaitermaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptwaitermaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptwaitermaster = New Crptwaitermaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
