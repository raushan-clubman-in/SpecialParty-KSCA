...
Public Class Crptcan_item
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptcan_item.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptcan_item
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptcan_item = New Crptcan_item()
        rpt.Site = Me.Site
        Return rpt
    End Function
