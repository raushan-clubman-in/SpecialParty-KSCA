...
Public Class Crptposmaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.Crptposmaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptposmaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptposmaster = New Crptposmaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
