...
Public Class CRPT_PAR_GSTBILL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SpecialParty.CRPT_PAR_GSTBILL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_GSTBILL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_GSTBILL = New CRPT_PAR_GSTBILL()
        rpt.Site = Me.Site
        Return rpt
    End Function
