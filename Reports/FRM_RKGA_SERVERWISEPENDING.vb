...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label7.Location = New System.Drawing.Point(467, 142)
        ...
        Me.Chk_Servercode.Location = New System.Drawing.Point(467, 118)
        ...
        Me.Chklist_ServerCode.Location = New System.Drawing.Point(467, 166)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(864, 211)
        Me.GroupBox4.Name = "GroupBox4"
        Me.GroupBox4.Size = New System.Drawing.Size(136, 356)
        ...
        Me.cmdreport.Location = New System.Drawing.Point(2, 129)
        ...
        Me.CmdClear.Location = New System.Drawing.Point(4, 52)
        ...
        Me.cmdexport.Location = New System.Drawing.Point(3, 205)
        ...
        Me.Label1.Text = "BEARER WISE KOT PENDING"
        '
        'Timer1
        '
        '
        ...
        Me.Chklist_POSLocation.Location = New System.Drawing.Point(230, 166)
        ...
        Me.Label6.Location = New System.Drawing.Point(230, 142)
        ...
        Me.Chk_SelectAllPos.Location = New System.Drawing.Point(230, 118)
        ...
        Me.chk_pending.Location = New System.Drawing.Point(332, 545)
        ...
        Me.chk_miss.Location = New System.Drawing.Point(494, 545)
        ...
        Me.Controls.Add(Me.chk_miss)
        Me.Controls.Add(Me.chk_pending)
...
#End Region
    ...
    Private Sub pendingkotEXCEL()
        ...
        If gdataset.Tables("CANCEL").Rows.Count > 0 Then
            exp.Show()
            Call exp.export(sqlstring, "PENDING KOT " & Format(mskFromDate.Value, "dd-MMM-yyyy") & "   TO   " & Format(mskToDate.Value, "dd-MMM-yyyy"), "")
    ...
    Private Sub missing_kotEXCEL()
        ...
        sqlstring = "SELECT * FROM MISSKOT order by kotno"
        gconnection.getDataSet(sqlstring, "MISSING")
        If gdataset.Tables("MISSING").Rows.Count > 0 Then
            exp.Show()
            Call exp.export(sqlstring, "MISSING -KOT " & Format(mskFromDate.Value, "dd-MMM-yyyy") & "   TO   " & Format(mskToDate.Value, "dd-MMM-yyyy"), "")
    ...
    Private Sub cmdreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdreport.Click
        ...
        Else
            ...
            vconn.ExcuteStoreProcedure(sqlstring)
            sqlstring = "SELECT * FROM MISSKOT order by kotno"
            Call Viewer.GetDetails(sqlstring, "MISSKOT", R1)
            Viewer.Show()
            ' Exit Sub
            'End If
        End If
