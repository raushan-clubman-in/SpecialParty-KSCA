...
Public Class BILLWISE_TAX
    ...
    Public Function Detailsection(ByVal SQLSTRING As String, ByVal pageheading() As String, ByVal HNAME As String, ByVal mskfromdate As Date, ByVal msktodate As Date)
        ...
        Try
            ...
            If gdataset.Tables("SALEREGISTERSUMMARY").Rows.Count > 0 Then
                ...
                pagesize = pagesize + 1
                '''******************************************** $  GRAND TOTAL $   ****************************************''''
                Filewrite.WriteLine(StrDup(149, "="))
                pagesize = pagesize + 1
    ...
    Private Function PrintHeader(ByVal HNAME As String, ByVal MSKFROMDATE As Date, ByVal MSKTODATE As Date)
        ...
        Try
            ...
            Filewrite.WriteLine(StrDup(149, "="))
            pagesize = pagesize + 1
            Filewrite.WriteLine("{0,-7}{1,-10}{2,-27}{3,11}{4,10}{5,10}{6,10}{7,10}{8,10}{9,10}{10,10}{11,10}{12,13}", "SLNO.", "ITEM CODE", "ITEM DESCRIPTION", "KOTDATE", "KOTNO", "QUANTITY", "RATE", "POSCODE", "GROUPCODE", "TAXCODE", "AMOUNT", "TAXAMOUNT", "TOTALAMOUNT")
            pagesize = pagesize + 1
            Filewrite.WriteLine(StrDup(149, "="))
            pagesize = pagesize + 1
