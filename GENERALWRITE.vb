...
Public Class generalwrite
    ...
    Public Function FnReadDataFile() As Boolean
        ...
        Dim path As String = "C:\KGACARD\Write.txt"
        ...
        Try
            ...
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sLock = (Me.WizObj.sLock & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sCrdNo = (Me.WizObj.sCrdNo & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sName = (Me.WizObj.sName & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sClub = (Me.WizObj.sClub & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sACNo = (Me.WizObj.sACNo & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sAmt = (Me.WizObj.sAmt & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sSecDep = (Me.WizObj.sSecDep & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
            ...
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sCardValidity = (Me.WizObj.sCardValidity & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sDOI = (Me.WizObj.sDOI & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sTOI = (Me.WizObj.sTOI & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sMode = (Me.WizObj.sMode & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sCCREFNO = (Me.WizObj.sCCREFNO & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sUSER = (Me.WizObj.sUSER & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sMEMCODE = (Me.WizObj.sMEMCODE & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sSPCODE = (Me.WizObj.sSPCODE & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Do While (str2.Substring(startIndex, 1) <> "~")
                Me.WizObj.sDPCODE = (Me.WizObj.sDPCODE & str2.Substring(startIndex, 1))
                startIndex += 1
            Loop
            startIndex += 1
            Me.WizObj.sEXTRA = " "
            'Do While (str2.Substring(startIndex, 1) <> "~")
            '    Me.WizObj.sEXTRA = (Me.WizObj.sEXTRA & str2.Substring(startIndex, 1))
            '    startIndex += 1
            'Loop
            startIndex += 1
            Me.WizObj.sEXTRA1 = " "
            'Do While (str2.Substring(startIndex, 1) <> """")
            '    Me.WizObj.sEXTRA1 = (Me.WizObj.sEXTRA1 & str2.Substring(startIndex, 1))
            '    startIndex += 1
            ' Loop
            stream.Close()
    ...
    Public Function FnWriteCard() As Boolean
        ...
        Dim buffer5 As Byte() = New Byte(3 - 1) {}
        ...
        If (CryptoDLL.PowerOn_CM(sReader) <> 0) Then
            ...
            Me.WizObj.sErrorMsg = "Error Powering on the Reader"
        ...
        If ((buffer10(0) = &H57) AndAlso (buffer10(1) = &H3F)) Then
            ...
            If (buffer11(0) = &H45) Then
                ...
                num3 = 0
                Do While (num3 < 8)
                    bInput(num3) = Me.bKEY(num3)
                    num3 += 1
                Loop
                ' index()
                For index = 0 To &H10 - 1
                    bInput(num3) = buffer3(index)
                    num3 += 1
                Next index
        ...
        s = Me.WizObj.sLock
        s = String.Concat(New String() {s, "#", Me.WizObj.sCrdNo, "#", Me.WizObj.sName})
        nOB = s.Length
        data = Encoding.ASCII.GetBytes(s)
        If (CryptoDLL.Write_User_Zone_CM(0, nOB, data) <> 0) Then
            Console.WriteLine("Error Writing Data in User Zone 0")
            Me.WizObj.sErrorMsg = (Me.WizObj.sErrorMsg & "Error Writing Data in User Zone 0")
            CryptoDLL.PowerOff_CM()
            General.Sleep(&H7D0)
            Return False
        End If
        s = ""
        s = (Me.WizObj.sClub & "#" & Me.WizObj.sACNo)
        s = String.Concat(New String() {s, "#", Me.WizObj.sAmt, "#", Me.WizObj.sSecDep, "#", Me.WizObj.sBal})
        nOB = s.Length
        data = Encoding.ASCII.GetBytes(s)
        ...
        End If
        s = ""
        s = Me.WizObj.sCardValidity
        s = String.Concat(New String() {s, "#", Me.WizObj.sDOI, "#", Me.WizObj.sTOI})
        s = String.Concat(New String() {s, "#", Me.WizObj.sMode, "#", Me.WizObj.sCCREFNO})
        nOB = s.Length
        data = Encoding.ASCII.GetBytes(s)
        ...
        End If
        s = ""
        s = (Me.WizObj.sUSER & "#" & Me.WizObj.sMEMCODE)
        s = (String.Concat(New String() {s, "#", Me.WizObj.sSPCODE, "#", Me.WizObj.sDPCODE, "#", Me.WizObj.sEXTRA}) & "#" & Me.WizObj.sEXTRA1)
        nOB = s.Length
        data = Encoding.ASCII.GetBytes(s)
        If (CryptoDLL.Set_Zone_CM(3, 0) <> 0) Then
            Console.WriteLine("Error Setting User Zone 3")
        ...
        If (CryptoDLL.Write_User_Zone_CM(0, nOB, data) <> 0) Then
            ...
            Return False
        End If
        If (((buffer9(0) <> &H42) OrElse (buffer11(0) <> &H45)) AndAlso Not flag) Then
            ...
            buffer5(1) = bOutput(1)
            buffer5(2) = bOutput(2)
            If (CryptoDLL.Write_Config_CM(&HE9, 3, buffer5) <> 0) Then
                Console.WriteLine("Error Writing Data in Config Zone")
                CryptoDLL.PowerOff_CM()
                General.Sleep(&H7D0)
                Return False
            End If
            If (CryptoDLL.Verify_Password_CM(0, 7, buffer5, False) <> 0) Then
                Console.WriteLine("Verify Password Failed")
                CryptoDLL.PowerOff_CM()
                General.Sleep(&H7D0)
                Return False
